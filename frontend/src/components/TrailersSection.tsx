...
import { PlayCircleIcon } from "lucide-react";
    ...
    return (
        <div className="bg-transparent px-6 md:px-16 lg:px-24 xl:px-44 py-20 overflow-hidden">
            ...
            <div className="relative mt-6">
                ...
                <ReactPlayer
                    ...
                    controls={false}
                    // playing
                    className="relative z-10 mx-auto max-w-full rounded-4xl overflow-hidden "
                    width="960px"
                    height="540px"
                    />
            </div>
